...
const COLUMNS: ColumnConfig[] = [
  ...
  { key: 'totalPlayed', label: '场次', align: 'right', sortable: true, getValue: (_t, _i, s) => s.totalPlayed || 0, defaultDir: 'desc' },
  { key: 'elo', label: 'Elo', align: 'right', sortable: true, getValue: (t) => t.elo, defaultDir: 'desc' },
  { key: 'avgXgFor', label: '总xG', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgXgFor, defaultDir: 'desc' },
  { key: 'avgXgAgainst', label: '总xGA', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgXgAgainst, defaultDir: 'desc' },
  { key: 'avgShots', label: '场均射门', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgShots, defaultDir: 'desc' },
  { key: 'avgShotsOnTarget', label: '场均射正', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgShotsOnTarget, defaultDir: 'desc' },
  { key: 'avgGoalsFor', label: '总进球', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgGoalsFor, defaultDir: 'desc' },
  { key: 'avgGoalsAgainst', label: '总失球', align: 'right', sortable: true, getValue: (_t, _i, s) => s.avgGoalsAgainst, defaultDir: 'desc' },
