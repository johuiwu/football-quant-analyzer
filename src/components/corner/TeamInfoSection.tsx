            ...
            <div className="space-y-3.5">
              ...
              <div className="p-3 bg-slate-900/40 border border-slate-850 rounded-xl space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-2 pt-1.5 border-t border-slate-850/60 text-[10px] font-mono text-slate-400">
                  <div className="truncate">主场 xG 预期进球: <span className="text-slate-200 font-bold">{activeTeam.homeStats.xgFor.toFixed(2)}</span></div>
                  <div className="truncate">主场 xG 预期失球: <span className="text-slate-200 font-bold">{activeTeam.homeStats.xgAgainst.toFixed(2)}</span></div>
                </div>
              </div>
              ...
              <div className="p-3 bg-slate-900/40 border border-slate-850 rounded-xl space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-2 pt-1.5 border-t border-slate-850/60 text-[10px] font-mono text-slate-400">
                  <div className="truncate">客场 xG 预期进球: <span className="text-slate-200 font-bold">{activeTeam.awayStats.xgFor.toFixed(2)}</span></div>
                  <div className="truncate">客场 xG 预期失球: <span className="text-slate-200 font-bold">{activeTeam.awayStats.xgAgainst.toFixed(2)}</span></div>
                </div>
              </div>
            </div>
          </div>
