...
export const DEFAULT_STRATEGIES = [
  ...
  { id: 2, enabled: false, name: "策略二 · 领先让球(50'-77')", market_type: "handicap", period: "full", minute_min: 50, minute_max: 77, leadGoals: 99, leadGoalsWeak: 0, line_min: -1.5, line_max: 1.5, odds_min: 0.8, odds_max: 1.3, direction: "Auto", corner_min: 0, corner_max: 99, leadSide: "any", aiFilterEnabled: false },
  { id: 3, enabled: false, name: "策略三 · 平局追角(70'-90')", market_type: "next_corner", period: "full", minute_min: 70, minute_max: 90, leadGoals: 0, leadGoalsWeak: 0, line_min: 0, line_max: 0, odds_min: 0.85, odds_max: 1.15, direction: "Auto", corner_min: 0, corner_max: 99, leadSide: "any", aiFilterEnabled: false },
  { id: 4, enabled: false, name: "策略四 · 领先大角(60'-80')", market_type: "over_under", period: "full", minute_min: 60, minute_max: 80, leadGoals: 99, leadGoalsWeak: 0, line_min: 7.5, line_max: 11.5, odds_min: 0.8, odds_max: 1.3, direction: "Over", corner_min: 0, corner_max: 99, leadSide: "any", aiFilterEnabled: false },
  { id: 5, enabled: false, name: "策略五 · 尾声保底(75'-90')", market_type: "next_corner", period: "full", minute_min: 75, minute_max: 90, leadGoals: 99, leadGoalsWeak: 0, line_min: 0, line_max: 0, odds_min: 0.8, odds_max: 1.0, direction: "Auto", corner_min: 0, corner_max: 99, leadSide: "any", aiFilterEnabled: false },
  { id: 6, enabled: false, name: "策略六 · 逆风让球(55'-70')", market_type: "handicap", period: "full", minute_min: 55, minute_max: 70, leadGoals: 99, leadGoalsWeak: 0, line_min: -1.5, line_max: 1.5, odds_min: 0.9, odds_max: 1.3, direction: "Auto", corner_min: 0, corner_max: 99, leadSide: "any", aiFilterEnabled: false },
