  ...
  try {
    ...
    if (teamData.homeStatsJson) {
      ...
      homeStats = {
        ...
        xgFor: teamData.avgGoals ? teamData.avgGoals * homePlayed : 0,
        xgAgainst: teamData.avgConceded ? teamData.avgConceded * homePlayed : 0,
      };
      awayStats = {
        played: awayPlayed,
        ...
        goalsAgainst: Math.round(teamData.conceded * 0.5),
        xgFor: teamData.avgGoals ? teamData.avgGoals * awayPlayed * 0.85 : 0,
        xgAgainst: teamData.avgConceded ? teamData.avgConceded * awayPlayed * 1.1 : 0,
      };
    }
