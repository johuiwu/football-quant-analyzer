...
WL("  - Storage: CRy4Xi7NaT (Uri) = https://www.hga038.com/")
...
WL("")
WL("### Runtime Behavior:")
WL("  - mAS495kb4k('https://www.hga038.com') returns False")
...
WL("  1. Taking HgUrl (https://www.hga038.com)")
WL("  2. Converting https:// -> wss://")
WL("  3. Appending a path (encrypted, only visible at runtime)")
WL("  ")
WL("  Top candidates:")
WL("    wss://www.hga038.com/ws")
WL("    wss://www.hga038.com/socket")
WL("    wss://www.hga038.com/api/ws")
WL("    wss://www.hga038.com/v1/ws")
WL("    wss://www.hga038.com/realtime")
WL("    wss://www.hga038.com/signalr/connect")
WL("    wss://www.hga038.com/hg/ws")
WL("")
